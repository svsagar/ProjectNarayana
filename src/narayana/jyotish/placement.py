"""Graha placement classification for Project Narayana Jyotish."""
...
class GrahaPlacement:
    """Canonical Jyotish placement of a Graha."""
...
def calculate_graha_placement(
    graha: Graha,
    longitude: float,
) -> GrahaPlacement:
    """Calculate the Rashi and Nakshatra placement of a Graha."""
